...
<html>
    ...
    <body>        
        <form id="form1" runat="server">
            This example code illustrates how to use an IndexedDB database by creating a very simple grocery app.

            <br><br>Tested in IE10, Chrome, and Firefox
            ...
            <!-- The form to created/edit the shopping list name -->
            <div class="divForm">
            ...
            <div class="divTitle">Categories...</div>
            <div class="divList">
